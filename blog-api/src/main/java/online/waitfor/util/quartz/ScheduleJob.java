...
import online.waitfor.service.ScheduleJobService;
...
public class ScheduleJob extends QuartzJobBean {
	...
	protected void executeInternal(JobExecutionContext context) {
		online.waitfor.entity.ScheduleJob scheduleJob = (online.waitfor.entity.ScheduleJob) context.getMergedJobDataMap().get(online.waitfor.entity.ScheduleJob.JOB_PARAM_KEY);
		//获取spring bean
