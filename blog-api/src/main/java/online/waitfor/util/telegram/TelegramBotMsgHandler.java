package online.waitfor.util.telegram;

import lombok.extern.slf4j.Slf4j;
import online.waitfor.config.properties.BlogProperties;
import online.waitfor.config.properties.TelegramProperties;
import online.waitfor.entity.Comment;
...
public class TelegramBotMsgHandler {
	...
	private String replyComment(String msgContent) {
		...
		if (splitIndex2 != -1 && msgContent.length() > splitIndex2 + 1) {
			...
			online.waitfor.model.dto.Comment comment = new online.waitfor.model.dto.Comment();
