package online.waitfor.controller.admin;

import com.github.pagehelper.PageHelper;
import com.github.pagehelper.PageInfo;
import online.waitfor.entity.Blog;
...
import online.waitfor.annotation.OperationLogger;
...
public class BlogAdminController {
	...
	@PostMapping("/blog")
	public Result saveBlog(@RequestBody online.waitfor.model.dto.Blog blog) {
	...
	@PutMapping("/blog")
	public Result updateBlog(@RequestBody online.waitfor.model.dto.Blog blog) {
	 ...
	 * @return
	 */
	private Result getResult(online.waitfor.model.dto.Blog blog, String type) {
		//验证普通字段
