...
import online.waitfor.exception.NotFoundException;
import online.waitfor.exception.PersistenceException;
import online.waitfor.mapper.BlogMapper;
...
import online.waitfor.util.JacksonUtils;
...
public class BlogServiceImpl implements BlogService {
	...
	@Override
	public List<online.waitfor.entity.Blog> getListByTitleAndCategoryId(String title, Integer categoryId) {
	...
	@Override
	public List<online.waitfor.entity.Blog> getIdAndTitleList() {
	...
	@Override
	public online.waitfor.entity.Blog getBlogById(Long id) {
		online.waitfor.entity.Blog blog = blogMapper.getBlogById(id);
		if (blog == null) {
