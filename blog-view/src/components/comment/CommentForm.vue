    ...
    <el-form :inline="true" :model="commentForm" :rules="formRules" ref="formRef" size="small">
      ...
      <el-form-item prop="nickname">
        <el-popover ref="nicknamePopover" placement="bottom" trigger="focus"
                    content="输入QQ号将自动拉取昵称和头像"></el-popover>
      ...
      <el-form-item prop="code" style="text-align: justify">
        <el-popover ref="codePopover" placement="bottom" trigger="focus" content="邮箱验证"></el-popover>
        <el-input style=width:150px id="code" v-model="commentForm.code" placeholder="验证码（必填）"
                  :validate-event="false" v-popover:codePopover>
          <i slot="prefix" class="el-input__icon el-icon-message"></i>
        </el-input>
      </el-form-item>
      <el-form-item>
        <el-button type="primary" size="medium" v-throttle="[sendCode,`click`,3000]">发送验证码</el-button>
      </el-form-item>
      <br>
  ...
  methods: {
    ...
    sendCode() {
      ...
      if (this.commentForm.email === '') {
        ...
        return this.$store.dispatch('submitEmailForm', blogToken ? blogToken : '')
      }
    },
    postForm() {
